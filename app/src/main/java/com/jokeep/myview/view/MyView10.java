...
/**
 * Created by wbq501 on 2016-1-15 15:00.
 * MyView
 */
public class MyView10 extends View{
    ...
    private void init(AttributeSet attrs, int defStyle) {
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.MyView10, defStyle, 0);
        percent = a.getInt(R.styleable.MyView10_percent, 0);
        allLineColor = a.getColor(R.styleable.MyView10_allLineColor, Color.GRAY);
        percentLineColorLow = a.getColor(R.styleable.MyView10_percentLineColorLow, Color.GREEN);
        percentLineColorHight = a.getColor(R.styleable.MyView10_percentLineColorHight, Color.RED);
        a.recycle();
